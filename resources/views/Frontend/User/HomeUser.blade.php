...
<div class="pmanager-left">
    ...
    <div class="user-info-right">
        <h2 class="username">12D3.32. Chu Minh Phương</h2>
...
<form action="/tai-khoan.html" class="form-horizontal" enctype="multipart/form-data" id="frmSubmit" method="post" role="form" novalidate="novalidate">                        <div class="form-group w-100">
                            <label for="">Mã tài khoản</label>
                            <div class="input-group">
                                <span class="input-group-text">#</span>
                                <input class="form-control text-box single-line" data-val="true" data-val-required="The UserId field is required." disabled="True" id="UserId" name="UserId" type="number" value="115539">
                            </div>
                        </div>
                        <div class="form-group w-100">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control text-box single-line" data-val="true" data-val-required="Vui lòng nhập họ tên" id="FullName" name="FullName" type="text" value="12D3.32. Chu Minh Phương">
                        ...
                        <div class="form-group w-100">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control text-box single-line" data-val="true" data-val-email="Email không hợp lệ" disabled="True" id="Email" name="Email" type="email" value="chuphuong10d3@gmail.com">
                            <span class="input-group-text">
                        ...
                        <div class="form-group w-100">
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input class="form-control text-box single-line" id="Mobile" maxlength="10" name="Mobile" numbersonly="true" type="text" value="">
                        ...
                        <div class="form-group mb-5 w-100">
                            ...
                            <div class="avatar">
                                <img id="srcImg" src="/assets/images/default-user.svg" alt="avatar" style="width:150px;height:150px">
                                <a href="javascript:;" id="change_avatar" class="btn btn-secondary">
                                    Chọn ảnh khác
                                </a>
                                <input type="file" name="Avatar" id="Avatar" onchange="showImg(event)" style="display:none">
                            </div>
                        </div>
                        <button type="submit" class="btn btn-danger w-100" id="btnSubmit">Cập nhật</button>
<input name="__RequestVerificationToken" type="hidden" value="CfDJ8PGJMKt0IShAuxdoB4DjH0YwF-KQVna7r3RBn8kVCGeghWtqFQS4FJCnYoC6V0hC_-HB2QxsEBQqzHk-3GafTt584LOG3GACd9xauxHAcp4DaYnzZ1eVUG2LqgzvUjS1-Wk2flo_Vp03I4qyDd8fQBfPcL0PQJYvUDrdYseomcJ0Zy3fjhfwD7h2TasrAv4cFw"></form>                </div>
            </div>
        </div>
    </div>
</div>
